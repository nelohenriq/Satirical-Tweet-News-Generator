...
export const ResultsDisplay: React.FC<ResultsDisplayProps> = ({ articles }) => {
  ...
  return (
    <section>
      <div className="flex justify-between items-center border-b-2 border-gray-light pb-2 mb-6">
        <h2 className="text-2xl font-bold text-text-primary">Generated Content</h2>
        <button
          onClick={handleDownload}
          className="flex items-center space-x-2 bg-gray-light hover:bg-gray-500 border border-gray-500 text-brand-secondary font-semibold py-1.5 px-3 rounded-md transition disabled:opacity-50"
